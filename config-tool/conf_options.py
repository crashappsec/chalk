...
all_fields = [
    # Basics pane
    "use_cmd", "use_docker", "use_cicd", "use_extract",
...
default_configs = [
    (base_config, "default", "Outputs to a logfile and stderr")
]
...
""")
        ...
        if is_true(d, "chalk_build_env"):
            lines.append(profile_set('chalk_max', 'INSERTION_HOSTINFO',
                                     'false'))
            lines.append(profile_set('chalk_max', 'INSERTION_NODENAME',
                                     'false'))
        #if is_true(d, "chalk_sig"):
    ...
    if is_true(d, "crpt_minimal"):
        ...
        lines.append(profile_set('chalk_art',  'OLD_CHALK_METADATA_HASH',
                                 'false'))
        lines.append(profile_set('chalk_art',  'OLD_CHALK_METADATA_ID',
                                 'false'))
        ...
        if not is_true(d, "crpt_host"):
            lines.append(profile_set('chalk_host', 'INSERTION_HOSTINFO',
                                     'false'))
            lines.append(profile_set('chalk_host', 'INSERTION_NODENAME',
                                     'false'))

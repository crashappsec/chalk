            ...
            [
                ContainsList(
                    [
                        ...
                        int,  # destination prefix len
                        "0000:0000:0000:0000:0000:0000:0000:0000",  # source
                        int,  # source prefix len
...
def test_codeowners(tmp_data_dir: Path, chalk: Chalk):
    ...
    artifact = tmp_data_dir / "helloworld.py"
    ...
    assert insert.marks_by_path.contains(
        {str(artifact): {"CODE_OWNERS": expected_owners}}
    )

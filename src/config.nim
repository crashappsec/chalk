...
## state lives.  A lot of this module consists of getters and setters,
## and some of the bits at the bottom are for actually loading
## configuration files. Hopefully the getters and setters will go away
## over time as con4m evolves.
##
## This module also captures some environmental bits used by other
## modules.  For instance, we collect some information about the build
## environment here.
##
## The actual config file spec is loaded here via include.
##
## Additionally, our core data types are included here (from
## types.nim), because there's a cross-dependency; some of the data
## types in that file require types generated by the con4m macro in
## the config file spec.  And, many things in this file are dependent
